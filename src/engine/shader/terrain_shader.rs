...
impl TerrainShader {
    pub unsafe fn new() -> Self {
        ...
        let shader_program = Self {
            ...
            isuphill_location: gl::GetUniformLocation(id, std::ffi::CStr::as_ptr(&CString::new("uIsUphill").unwrap())),
            height_location: gl::GetUniformLocation(id, std::ffi::CStr::as_ptr(&CString::new("uHeight").unwrap())),
        };
